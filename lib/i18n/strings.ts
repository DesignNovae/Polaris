...
export const strings: Record<Lang, AnyDict> = {
  en: {
    ...
    how: {
      ...
      step2: "Polaris builds a structured, quarter-by-quarter roadmap grounded in retrieval-augmented university data.",
  ...
  bn: {
    ...
    how: {
      ...
      step2: "Polaris আপনার জন্য কোয়ার্টার-ভিত্তিক, স্ট্রাকচার্ড রোডম্যাপ তৈরি করে-RAG-ভিত্তিক বিশ্ববিদ্যালয় ডেটার উপর গ্রাউন্ডেড।",
